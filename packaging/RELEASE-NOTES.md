...
1. Pak de zip uit.
2. Start **Installeer Venster-Memory.command** met **rechtermuisknop → Open**. De eerste keer met
...
- Universal: Apple Silicon en Intel, macOS 14 of nieuwer.
- Ad-hoc gesigneerd, niet genotariseerd. Safari vraagt daarom om
  **Ontwikkelaar → "Sta niet-ondertekende extensies toe"**, en zet die na elke herstart weer uit.
  Dat is weg te krijgen met een Apple Developer-account: sinds Safari 18.4 accepteert Safari
  extensies die met een Developer ID zijn ondertekend en genotariseerd.
- Tabbladgroepen laat de extensie met rust; die bewaart Safari zelf al.
